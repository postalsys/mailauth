...
const { formatAuthHeaderRow, parseDkimHeaders, formatDomain, getAlignment, validateRecordType } = require('../tools');
...
const lookup = async data => {
    ...
    if (recordData?.parsed?.a?.value) {
        ...
        const authorityUriValidationObj = validateRecordType(recordData.parsed.a.value, 'bimi');
