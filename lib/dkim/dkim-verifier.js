...
const { getSignedHeaderLines, getPublicKey, parseDkimHeader, formatAuthHeaderRow } = require('../../lib/tools');
            ...
            for (let signatureHeader of this.signatureHeaders) {
                ...
                let status = {
                    ...
                    header: {
                        ...
                        // algo
                        a: signatureHeader.parsed.a,
                        // signature value
                        b: signatureHeader.parsed.b ? `${signatureHeader.parsed.b.substr(0, 8)}` : false
                    },
                    policy: {}
                };
