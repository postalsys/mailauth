    ...
    async messageHeaders(headers) {
        ...
        for (let signatureHeader of this.signatureHeaders) {
            ...
            signatureHeader.maxBodyLength =
                typeof signatureHeader.parsed?.l?.value === 'number' && !isNaN(signatureHeader.parsed?.l?.value) ? signatureHeader.parsed?.l?.value : '';
        ...
        try {
            ...
            for (let signatureHeader of this.signatureHeaders) {
                ...
                let result = {
                    ...
                    signingHeaders,
                    status,
                    signTime: signatureHeader.timestamp ? signatureHeader.timestamp.toISOString() : null,
                    expiresAfter: signatureHeader.expiration ? signatureHeader.expiration.toISOString() : null,
